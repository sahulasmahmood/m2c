  ...
  return (
    <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View key={item.id} className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
            ...
            <View className="flex-row gap-3 mb-3">
              <View className="flex-1">
                <Text className="text-xs text-gray-500 font-semibold mb-1">Total Qty</Text>
                <TextInput
              ...
              <View className="flex-1">
                <Text className="text-xs text-gray-500 font-semibold mb-1">Inspection Qty</Text>
                <TextInput
                  className="border border-gray-300 rounded-lg px-3 py-2 bg-white text-gray-900 text-sm"
      ...
      <View className="mt-4 mb-6">
        <Text className="text-sm font-bold text-gray-900 mb-3">Warehouse Photo Evidence</Text>

        <TouchableOpacity
          className="border-2 border-dashed border-gray-300 rounded-xl py-6 items-center justify-center bg-gray-50"
